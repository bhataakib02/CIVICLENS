...
def upgrade() -> None:
    ...
    if not insp.has_table("opportunity_sources"):
        op.create_table(
            "opportunity_sources",
    ...
    if not insp.has_table("opportunity_versions"):
        op.create_table(
    ...
    # 4. opportunity_links
    if not insp.has_table("opportunity_links"):
        op.create_table(
            "opportunity_links",
            sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("opportunity_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("opportunities.id", ondelete="CASCADE"), nullable=False),
    ...
    if not insp.has_table("opportunity_subscriptions"):
        op.create_table(
    ...
    if not insp.has_table("opportunity_alerts"):
        op.create_table(
            "opportunity_alerts",
            sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("user_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id", ondelete="CASCADE"), nullable=False),
    ...
    if not insp.has_table("raw_crawl_snapshots"):
        op.create_table(
            "raw_crawl_snapshots",
            sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
    ...
    if not insp.has_table("opportunity_changes"):
        op.create_table(
            "opportunity_changes",
            sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("opportunity_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("opportunities.id", ondelete="CASCADE"), nullable=False),
    ...
    if not insp.has_table("opportunity_application_tracks"):
        op.create_table(
    ...
    # 9. crawl_runs
    if not insp.has_table("crawl_runs"):
        op.create_table(
            "crawl_runs",
            sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
            sa.Column("source_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("opportunity_sources.id", ondelete="CASCADE"), nullable=False),
    ...
    # 10. crawl_items
    if not insp.has_table("crawl_items"):
        op.create_table(
            "crawl_items",
            sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
    ...
    if not insp.has_table("link_verifications"):
        op.create_table(
            "link_verifications",
            sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
